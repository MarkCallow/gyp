...
test $JAVA_FOLDER_PATH = bundle_shared_library.framework/Versions/A/Resources/Java
test $FRAMEWORKS_FOLDER_PATH = bundle_shared_library.framework/Versions/A/Frameworks
...
test $XPCSERVICES_FOLDER_PATH = bundle_shared_library.framework/Versions/A/XPCServices
